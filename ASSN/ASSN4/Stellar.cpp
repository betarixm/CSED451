...
Orb::Orb(const char *map_path, const char *normal_path, float x, float y, float z, float length, GLclampf colorfv[]) {
    this->_planet = new Sphere(map_path, normal_path, 20, 20, length, x, y, z, 0, colorfv);
}

Orb::Orb(const char *map_path, const char *normal_path, float x, float y, float z, float length, GLclampf colorfv[], Orb *satellite, float distance) {
    this->_planet = new Sphere(map_path, normal_path, 20, 20, length, x, y, z, 0, colorfv);
...
void initStellar() {
    ...
    const char * map_path[2][3] = {{"texture/sun.jpeg", "texture/earth.jpeg", "texture/moon.jpeg"},
                                   {"texture/jupiter.jpeg", "texture/mars.jpeg", "texture/neptune.jpeg"}};
